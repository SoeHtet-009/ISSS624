...
The code chunk below installs and launches R packages into the R environment.

```{r}
pacman::p_load(rgdal, spdep, tmap, sf, 
               ggpubr, cluster, factoextra, NbClust,
               heatmaply, corrplot, psych, tidyverse,rmarkdown)
```
...
```{r}
shan_sf <- st_read(dsn = "geospatial", 
...
```{r}
ict <- read_csv ("aspatial/Shan-ICT.csv")
```
...
### 5.5.2 EDA Using Choropleth Maps
...
### 5.7.1 Extracting Cluster Variables
...
#### 5.7.2.1 Min Max Standardization
...
#### 5.7.2.2 Z-Score Standardization
...
**W*arning: Z-score standardisation method should only be used if we would assume all variables come from some normal distribution.***

### 5.7.3 Visualizing Standardized Clustering Variables
...
### 5.7.4 Computing Proximity Matrix
...
### 5.7.5 Computing Hierarchical Clustering
...
### 5.7.6 Selecting Optimal Clustering Algorithm
...
### 5.7.7 Determining Optimal Cluster
...
### 5.7.9 Visually Driven Hierarchical Cluster Analysis
...
#### 5.7.9.1 Transforming The Dataframe Into Matrix
...
#### 5.7.9.2 Plotting Interactive Cluster Heatmap Using Heatmaply
...
#### 5.7.10 Mapping The Clusters Formed
...
### 5.8.1 Converting Into Spatial Polygon Dataframe
...
### 5.8.4 Computing Spatially Constrained Clusters Using Skater Method
...
### 5.8.5 Visualizing The Clusters In Choropleth Maps
...
### 5.9.1 A short note about ClustGeo Package
...
### 5.9.2 Ward-like Hierarchical Clustering : ClustGeo
...
#### 5.9.2.1 Mapping The Clusters Formed
...
### 5.9.3 Spatially Constrained Hierarchical Clustering
