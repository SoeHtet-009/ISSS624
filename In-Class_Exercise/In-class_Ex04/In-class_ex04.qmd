...
## 6.4 A Short Note About GW Model
...
### 6.6.2 Converting Aspatial Data to Sf Object
...
### 6.7.2 Muliple Histogram Distribution Plots
...
## 6.8 Hedonic Pricing Modelling

ln this section, you will learn how to building hedonic pricing models for condominium resale units using [`lm()`](https://www.rdocumentation.org/packages/stats/versions/3.5.2/topics/lm) of R base.
...
l`m()` returns an object of class "lm" or for multiple responses of class c("mlm", "lm").
...
### 6.8.2 Multiple Linear Regression

#### 6.8.2.1 Visualizing the Relationships Between Variables
...
corrplot(cor(condo_resale[, 5:23]), diag = FALSE, order = "AOE",
         tl.pos = "td", tl.cex = 0.5,number.cex = .45, method = "number", type = "upper")
```
...
### 6.8.6 Checking for Multicolinearity
...
### 6.8.8 Test for Normality Assumption
...
The summary table above reveals that the p-values of the four tests are way smaller than the alpha value of 0.05. Hence we will reject the null hypothesis that the residual resembles normal distribution.

### 6.8.9 Testing For Spatial Autocorrelation
...
## 6.9 Building Hedonic Pricing Model Using GWModel
...
### 6.9.4 Converting SDF Into sf Dataframe
...
## 6.10 Visualizing Coefficient Estimates

The code chunk below is used to create interactive point symbol map.
